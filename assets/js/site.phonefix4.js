...
(function () {
  ...
  var localPhoneDigits = function (value) {
    ...
    if (compact.indexOf('+7') === 0) {
      ...
      while (digits.length > 10 && digits.charAt(0) === '7') {
        digits = digits.slice(1);
      }
  ...
  [].forEach.call(document.querySelectorAll('[data-lead-form]'), function (form) {
    ...
    if (phoneField) {
      var prevDigits = localPhoneDigits(phoneField.value);
      phoneField.addEventListener('input', function (e) {
        var deleting = e && e.inputType && e.inputType.indexOf('delete') === 0;
        var digits = localPhoneDigits(phoneField.value);
      ...
      phoneField.addEventListener('focus', function () {
        if (!phoneField.value) { phoneField.value = '+7 '; prevDigits = localPhoneDigits(phoneField.value); }
      });
      phoneField.addEventListener('blur', function () {
        if (localPhoneDigits(phoneField.value).length < 1) phoneField.value = '';
      });
    }
    ...
    form.addEventListener('submit', function (e) {
      ...
      if (phoneField) {
        ...
        resetFieldError(phoneField);
        if (localPhoneDigits(phoneField.value).length !== 10) {
